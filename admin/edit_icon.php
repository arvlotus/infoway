...
// Verifica se um ID de imagem foi passado via GET
...
$query = "SELECT title, image FROM icons WHERE id = '$icon_id'";
...
$pageInfo = array(
    'title' => 'Editar Icone',
    'description' => 'Edite seu icone existente.',
    'pageName' => 'edit_icon',
);
        ...
        <section class="col-md-9">
            ...
            <div class="card-alunos">
                <div class="card-body">
                    ...
                    <form action="requests/request_edit_icon.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-3">
                            <label for="image">Imagem do Icone</label>
