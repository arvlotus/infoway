                                ...
                                style="max-width: 100px;">
                                    ...
                                    <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <li>
                                                    <a class="dropdown-item" href="edit_banner.php?banner_id=<?= $banner['id'] ?>"><i class="bi bi-pencil-square"></i>
                                                        Editar</a>
                                                </li>

                                                <li>
                                                    <a class="dropdown-item text-danger" href="requests/request_delete_banner.php?banner_id=<?= $banner['id'] ?>"><i class="bi bi-trash-fill"></i>
                                                        Excluir</a>
                                                </li>
                                            </ul>
                                        </div>
